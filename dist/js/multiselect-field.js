...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-multiselect-field', __webpack_require__(3));
  Vue.component('detail-multiselect-field', __webpack_require__(6));
  Vue.component('form-multiselect-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    values: function values() {
      ...
      return valuesArray.map(function (val) {
        return _this.field.options.find(function (opt) {
          return String(opt.value) === String(val);
        });
      }).filter(function (val) {
          ...
          ? _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass:
                      "bg-white overflow-hidden rounded-b-lg rounded-t-lg"
                  },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getOptions: function getOptions(query) {
            var _this = this;
            ...
            Nova.request().get(this.field.searchUrl, {
                ...
                _this.options = _typeof(response.data) === 'object' ? Object.values(response.data) : response.data;
            }).catch(function () {
                _this.options = [];
            }).finally(function () {
        ...
        setInitialValue: function setInitialValue() {
            ...
            if (this.field.value) {
                ...
                if (!Array.isArray(valuesArray)) {
                    this.value = this.field.options.find(function (opt) {
                        return String(opt.value) === String(valuesArray);
                    });
                    return;
                }

                this.value = valuesArray.map(function (val) {
                    return _this2.field.options.find(function (opt) {
                        return String(opt.value) === String(val);
                    });
                }).filter(function (val) {
                    return !!val;
          ...
          _c(
            "multiselect",
            {
              ...
              attrs: {
                ...
                "close-on-select":
                  typeof _vm.field.multiple !== "undefined"
                    ? !_vm.field.multiple
                    : false,
                ...
                allowEmpty: _vm.field.allowEmpty,
                optionsLimit: _vm.field.optionsLimit || 1000,
                searchable: _vm.field.searchable,
                loading: _vm.isLoading,
                "hide-selected": _vm.field.searchable,
                "show-no-results": !_vm.field.searchable,
                "internal-search": !_vm.field.searchable,
                "option-height":
                  _vm.field.template === "posts" ||
                  _vm.field.template === "two-rows"
                    ? 60
                    : 40,
                "show-labels": false
              },
                ...
                [
                  {
                    key: "option",
                    fn: function(props) {
                      return _vm.field.template === "two-rows"
                        ? [
                            _c("div", { staticStyle: { width: "100%" } }, [
                              _c(
                                "div",
                                {
                                  ...
                                  attrs: { title: props.option.label }
                                },
                                [
                                  _c("span", [
            ...
            [
              _vm.field.noOptions
                ? _c("template", { slot: "noOptions" }, [
                    _vm._v(_vm._s(_vm.field.noOptions))
                  ])
                : _vm._e(),
              _vm._v(" "),
              _vm.field.noResults
                ? _c("template", { slot: "noResults" }, [
                    _vm._v(_vm._s(_vm.field.noResults))
                  ])
                : _vm._e()
            ],
            2
